...
class TestConstructDovecotConfigFileContent:
...
class TestConstructDovecotUserFileContent:
    @pytest.mark.parametrize(
    ...
    def test_content_construction(self, smtp_auth_users: list[str], expected_content: str) -> None:
        """
